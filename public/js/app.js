...
/* harmony import */ var _js_admin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/admin */ "./resources/js/admin.js");
...
console.log(statuses); //fetching the order object via input field
...
if (order) {
  socket.emit('join', "order_".concat(order._id)); // this is sending req to server for connect socket with room with unique id Which is in 2 aurgument of emit method
}

var adminAreaPath = window.location.pathname;

if (adminAreaPath.includes('admin')) {
  Object(_js_admin__WEBPACK_IMPORTED_MODULE_3__["initAdmin"])(socket);
  socket.emit('join', 'adminRoom'); //here socket  room name is adminRoom
}

socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //this right side expression is used to copy a object to another syntex {...objectName}


  updatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_2___default()().format(); //stroring current time
...
__webpack_require__(/*! E:\NodeJsProjects\realtime-pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\NodeJsProjects\realtime-pizza\resources\scss\app.scss */"./resources/scss/app.scss");
